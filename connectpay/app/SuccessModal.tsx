// app/SuccessModal.tsx - Custom Success Modal Component
    ...
    >
      <View style={styles.overlay}>
        <View style={styles.modalContainer}>
          ...
          {/* Content */}
          <Text style={styles.subtitle}>{networkName} Airtime Purchase Complete</Text>
          ...
          <Text style={styles.thankYou}>Thank you for using our service!</Text>
          ...
          <View style={styles.buttonContainer}>
            <TouchableOpacity 
              ...
              onPress={onBuyMore}
            >
              <Text style={styles.buyMoreText}>Buy More Airtime</Text>
            </TouchableOpacity>
